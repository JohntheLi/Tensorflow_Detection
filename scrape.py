...
def main():
    ...
    parser.add_argument('-s', '--search', default='Eiffel Tower', type=str, help='search term')
    parser.add_argument('-n', '--num_images', default=200, type=int, help='num images to save')
    parser.add_argument('-d', '--directory', default='/Users/John/Desktop/Codeology Tensorflow/ObjectDetection/Images/', type=str, help='save directory')
